...
export function Card({ text, phase, direction }: CardProps) {
  return (
    <div className="flex items-center justify-center px-6 py-3 h-[70vh] font-bold text-[var(--color-fg)] text-2xl border-3 border-fg shadow-[5px_5px_0_0_#000] overflow-hidden">
